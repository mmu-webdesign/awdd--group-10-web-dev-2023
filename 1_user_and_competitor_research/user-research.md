...
•	"There is so much conflicting information when searching for advice on dog care, therefore it would be a great idea for the site to contain relevant, useful information in one place."
...
• Needs and goals: Due to the large number of features, the site will need to be structured logically and make sense.
...
•	"We recently got a dog, and I think it would be so useful to have a single place containing so much useful information about dogs, as it can be difficult when raising a dog from a puppy/a young age."
...
•	Likes: Likes the prospect of having an online guide as it makes accessing it easy (anywhere at any time). The guide can also be spread online for others to use and raise awareness on the numbers of dogs that need adopting and the improvement of animal care that is needed.
